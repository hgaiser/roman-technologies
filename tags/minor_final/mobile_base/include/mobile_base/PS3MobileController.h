#ifndef __PS3MOBILECONTROLLER_H
#define __PS3MOBILECONTROLLER_H
...
public:
	/// Constructor
	PS3MobileController() : mNodeHandle(""), mControlMode(PS3_CONTROL_GAME), mPrevAngular(0.f), mPrevLeftSpeed(0.f), mPrevRightSpeed(0.f) { }
