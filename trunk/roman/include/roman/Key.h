/* Auto-generated by genmsg_cpp for file /home/hans/Minor-Robotica/ros_workspace/grijpertest/msg/Key.msg */
#ifndef GRIJPERTEST_MESSAGE_KEY_H
#define GRIJPERTEST_MESSAGE_KEY_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
private:
  static const char* __s_getDataType_() { return "grijpertest/Key"; }
public:
...
public:
  ...
  typedef boost::shared_ptr< ::grijpertest::Key_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::grijpertest::Key_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct Key
typedef  ::grijpertest::Key_<std::allocator<void> > Key;

typedef boost::shared_ptr< ::grijpertest::Key> KeyPtr;
typedef boost::shared_ptr< ::grijpertest::Key const> KeyConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::grijpertest::Key_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::grijpertest::Key_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::grijpertest::Key_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::grijpertest::Key_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::grijpertest::Key_<ContainerAllocator> > {
  static const char* value() 
  {
    return "647e6845363f4bdce24380c5a29aeb12";
  }

  static const char* value(const  ::grijpertest::Key_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x647e6845363f4bdcULL;
  static const uint64_t static_value2 = 0xe24380c5a29aeb12ULL;
};

template<class ContainerAllocator>
struct DataType< ::grijpertest::Key_<ContainerAllocator> > {
  static const char* value() 
  {
    return "grijpertest/Key";
  }
...
template<class ContainerAllocator>
struct Definition< ::grijpertest::Key_<ContainerAllocator> > {
  static const char* value() 
  {
    return "uint8[] keys\n\
uint8[] values\n\
...
template<class ContainerAllocator> struct Serializer< ::grijpertest::Key_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::grijpertest::Key_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::grijpertest::Key_<ContainerAllocator> & v) 
  {
...
#endif // GRIJPERTEST_MESSAGE_KEY_H
