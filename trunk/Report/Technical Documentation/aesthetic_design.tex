...
\end{figure}
 ...
 \begin{figure}[h!]
  ...
  {\label{fig:render_eva}\includegraphics[width=0.45\textwidth]{Images/SW_almostfullrender.png}}    
  \hspace{2mm}            
  \subfloat[Photo of Eva]{\label{fig:photo_eva}\includegraphics[width=0.3\textwidth]{Images/Evacomplete.png}}
...
\end{figure}
 ...
 \begin{figure}[h!]
  ...
  {\label{fig:render_head}\includegraphics[width=0.46\textwidth]{Images/SW_halfmodel1.PNG}}    
  \hspace{2mm}            
  \subfloat[The other part of the head.]{\label{fig:photo_head}\includegraphics[width=0.45\textwidth]{Images/SW_halfmodel2.PNG}}
