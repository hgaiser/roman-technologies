...
#include <grijpertest/MotorControl.h>
#include <grijpertest/Key.h>
...
public:
    ...
    void keyCB(const grijpertest::KeyPtr& msg);
    void readSensorDataCB(const grijpertest::DistancePtr& msg);
};    
