...
#include <grijpertest/Distance.h>
...
grijpertest::Distance dis_msg;
grijpertest::Temperature temp_msg;  
...
ros::NodeHandle  nh;
ros::Subscriber<std_msgs::Empty> sub("/grijpertest/sensorTopic", &activateSensorCB);
ros::Publisher ultrasone_pub("/grijpertest/sensorFeedbackTopic", &dis_msg);
ros::Publisher temperature_pub("/grijpertest/temperatureFeedbackTopic", &temp_msg);
