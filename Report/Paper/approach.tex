...
Another option for object avoidance is by using the object avoidance in Detour \pageref{Global} . With this, Eva will dynamically add objects whenever she sees one and plan her route around the object beforehand. Eva supports both types of avoidance, but further research needs to be conducted to improve on of the two methods.
