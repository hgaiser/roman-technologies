...
#define ROBOT_ANGULAR_SPEED 	(1/current_speed.linear.x*10) * SPEED_CONST
...
protected:
	...
	ros::Subscriber speed_sub;		 		/// Listens to Twist messages as feedback for robot's current speed
	...
	geometry_msgs::Twist current_speed;		/// Holds current speed of the robot
