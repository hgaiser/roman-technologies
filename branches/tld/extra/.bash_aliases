...
alias head_normal='rostopic pub /cmd_head_position nero_msgs/PitchYaw 0 0'
alias head_detect='rostopic pub /cmd_head_position nero_msgs/PitchYaw 0.4 0'
alias head_face='rostopic pub /cmd_head_position nero_msgs/PitchYaw -- -0.2 0'
alias head_sleep='rostopic pub /cmd_head_position nero_msgs/PitchYaw 0.6 0'
...
alias wake_up='rostopic pub /processedSpeechTopic nero_msgs/speech "wake up" 0'
alias sleep='rostopic pub /processedSpeechTopic nero_msgs/speech "sleep" 0'
alias juice='rostopic pub /processedSpeechTopic nero_msgs/speech "juice" 0'
alias cola='rostopic pub /processedSpeechTopic nero_msgs/speech "cola" 0'
